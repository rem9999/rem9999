...
const owners = [
    {
        ...
        "post": "Bot Developer",
        "GHURL": "https://github.com/moon-9999",
        "InstaURL": "",
...
for (let indexOne = 0; indexOne < owners.length; indexOne++) {
    ...
    $.getJSON(API + elementOwners.id)
        .then(output => {
            ...
            const ownerList = "<div id='trigger' class='card' style='margin: 15px;'><div class='banner'><img src='" + output.url + "'></div></br></br></br></br><h2 class='name'>" + output.username + "</h2><div class='title'><h1 id='trigger2'color: #000000;'' style='font-size: 26px; color: #000000;'>" + elementOwners.post + "</h2></div><div class='actions'><div class='follow-btn' style='margin-bottom: 5px;'><a href='" + elementOwners.GHURL + "' target='_blank'><button style='color: #000000;'>GitHub</button></a></div><div class='follow-btn'><a href='"
